...
public class forward_edited_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_e64eno_a(editorContext, node);
  }
  private EditorCell createCollection_e64eno_a(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(editorContext, node);
    editorCell.setCellId("Collection_e64eno_a");
    editorCell.setBig(true);
    editorCell.addEditorCell(this.createConstant_e64eno_a0(editorContext, node));
    editorCell.addEditorCell(this.createRefNode_e64eno_b0(editorContext, node));
    return editorCell;
  }
  private EditorCell createConstant_e64eno_a0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "Forward add values");
    editorCell.setCellId("Constant_e64eno_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_e64eno_b0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new forward_edited_Editor.added_expressionsSingleRoleHandler_e64eno_b0(node, MetaAdapterFactory.getContainmentLink(0x197a3f15e7884d9bL, 0xb6f9860847284fceL, 0x32c3c42914c2f474L, 0x32c3c42914c2f507L, "added_expressions"), editorContext);
    return provider.createCell();
  }
  private class added_expressionsSingleRoleHandler_e64eno_b0 extends SingleRoleCellProvider {
    public added_expressionsSingleRoleHandler_e64eno_b0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
