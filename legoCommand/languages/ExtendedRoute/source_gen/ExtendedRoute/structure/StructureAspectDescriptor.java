...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  private static ConceptDescriptor createDescriptorForNew_Expression() {
    return new ConceptDescriptorBuilder("ExtendedRoute.structure.New_Expression", MetaIdFactory.conceptId(0x197a3f15e7884d9bL, 0xb6f9860847284fceL, 0x32c3c42914dbdfc4L)).super_("jetbrains.mps.baseLanguage.structure.Expression").version(1).super_(MetaIdFactory.conceptId(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c37f506fL)).parents("jetbrains.mps.baseLanguage.structure.Expression").parentIds(MetaIdFactory.conceptId(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c37f506fL)).referenceDescriptors(new ConceptDescriptorBuilder.Ref(0x32c3c42914dbe6bdL, "var", MetaIdFactory.conceptId(0x197a3f15e7884d9bL, 0xb6f9860847284fceL, 0x41644b4f1c34f37fL), false, new SNodePointer("r:d679cd34-7db0-4a58-a9e5-9a64976f0d24(ExtendedRoute.structure)", "3657983003077633725"))).references("var").alias("New_expression", "").sourceNode(new SNodePointer("r:d679cd34-7db0-4a58-a9e5-9a64976f0d24(ExtendedRoute.structure)", "3657983003077631940")).create();
  }
